...
mondata SPECIES_LANTURN, "Lanturn"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 2, 0, 0, 0, 0, 0
    items ITEM_DEEP_SEA_TOOTH, ITEM_YELLOW_SHARD
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_SLOW
...
mondata SPECIES_PIDOVE, "Pidove"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_FLYING, EGG_GROUP_FLYING
    abilities ABILITY_FRISK, ABILITY_SUPER_LUCK
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
...
mondata SPECIES_CUFANT, "Cufant"
    ...
    abilities ABILITY_HEAVY_METAL, ABILITY_NONE
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
...
mondata SPECIES_GOLEM_ALOLAN, "Golem"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_MINERAL, EGG_GROUP_MINERAL
    abilities ABILITY_ROCK_HEAD,  ABILITY_MAGNET_PULL
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
